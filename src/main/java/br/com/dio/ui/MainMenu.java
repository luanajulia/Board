...
public class MainMenu {
    ...
    public void execute() throws SQLException {
        ...
        while (true){
            ...
            switch (option){
                ...
                case 2 -> selectBoard();
                case 3 -> deleteBoard();
                case 4 -> listAllBoards(); // Nova opção para listar todas as boards
    ...
    private void listAllBoards() { // Novo método para listar todas as boards
        try (var connection = ConnectionConfig.getConnection()) {
            var service = new BoardQueryService(connection);
            var boards = service.findAllBoards();
            if (boards.isEmpty()) {
                System.out.println("Nenhuma board encontrada.");
            } else {
                System.out.println("\n--- Todas as Boards ---");
            ...
            System.err.println("Erro ao listar boards: " + e.getMessage());
        }
    }
}
